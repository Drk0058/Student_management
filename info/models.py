...
class Course(models.Model):
    ...
    status = models.CharField(max_length=50, choices= lab_choice,  default='Theory')
    room = models.CharField(max_length=10, default='Room', blank=True)
    def __str__(self):
        return self.name
...
class Student(models.Model):
    ...
    Rollno = models.CharField(primary_key='True', max_length=50, blank=True)
    name = models.CharField(max_length=200)
...
class Assign(models.Model):
    ...
    def __str__(self):
        ...
        return '%s : %s : %s' % (te.name, cr.status, cl)


class AssignTime(models.Model):
    assign = models.ForeignKey(Assign, on_delete=models.CASCADE)
    period = models.CharField(max_length=50, choices=time_slots, default='8:30 - 9:25')
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                    ...
                    sc.save()
                    sc.marks_set.create(name='Mt 1')
                    sc.marks_set.create(name='Mt 2')
                    sc.marks_set.create(name='TA')
